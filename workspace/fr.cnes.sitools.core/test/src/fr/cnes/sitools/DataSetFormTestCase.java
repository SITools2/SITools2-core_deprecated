 ...
 * @author C MOZDZIERZ
 */
public class DataSetFormTestCase extends AbstractDataSetManagerTestCase {
  ...
  static {
    ...
    docAPI = new DocAPI(DataSetFormTestCase.class, "Dataset Filter API by Form with JSON format");
  ...
  public void testDataSetGridQueryingFilterDateBetweenField() {
    // un test avec un filtre string
    String params = "p[0]=DATE_BETWEEN|dateobs|2000-01-01T00:00:00.000|2000-01-06T00:00:00.000&start=0&limit=300&media=json";
    if (docAPI.isActive()) {
      Map<String, String> parameters = new LinkedHashMap<String, String>();
      parameters.put("URI dataset", "URI ");
      parameters.put("c[i]", "filter of form");
      ...
      parameters.put("2000-01-01|2000-01-06", "between 2000-01-01|2000-01-06");
