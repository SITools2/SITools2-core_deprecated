...
public abstract class AbstractNotificationAPITestCase extends AbstractSitoolsServerTestCase {
   ...
   * @param observable the observable to create
   */
  ...
  private RestletObservable createObservable() {
    ...
    NotificationStore store = new NotificationStoreXML();
   ...
   * @return Response
   */
  private static Response getResponse(MediaType media, Representation representation, Class<?> dataClass, boolean isArray) {
    try {
