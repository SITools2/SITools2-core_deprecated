  ...
  public Representation addObserver(Representation representation, Variant variant) {
    ...
    if (null != getObservableUUID()) {
      ...
      if (observable != null) {
        ...
        return SitoolsRepresentations.getRepresentation(new Response(false, "obervable.notfound"), variant);
      }
      return SitoolsRepresentations.getRepresentation(new Response(true, "observer.added"), variant);
    }
    else {
      throw new ResourceException(Status.CLIENT_ERROR_BAD_REQUEST, "observer.post.error");
    }
  ...
  public Representation deleteObserver(Representation representation, Variant variant) {
    if ((null != getObservableUUID()) && (null != getObserverUUID())) {
      ...
      if (observable != null) {
        ...
        return SitoolsRepresentations.getRepresentation(new Response(true, "observer.deleted"), variant);
      }
      else {
        return SitoolsRepresentations.getRepresentation(new Response(false, "observable.notfound"), variant);
      }
    }
    else {
