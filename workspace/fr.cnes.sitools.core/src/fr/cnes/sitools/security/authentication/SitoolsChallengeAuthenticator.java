...
public final class SitoolsChallengeAuthenticator extends DelegatedChallengeAuthenticator {
  ...
  public SitoolsChallengeAuthenticator(Context context, boolean optional, ChallengeScheme challengeScheme,
      String realm, SitoolsRealm sitoolsRealm, Verifier verifier, Enroler enroler,
  ...
  /**
   * Pour les clients sitools, client-admin, client-user qui utilisent le user agent dans leurs requêtes, on retourne
   * une reponse Sitools (non-Javadoc)
   * 
   * @param response
   *          the response
