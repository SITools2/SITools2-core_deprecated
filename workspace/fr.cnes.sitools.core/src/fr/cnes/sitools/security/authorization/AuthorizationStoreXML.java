...
public final class AuthorizationStoreXML extends Paginable<ResourceAuthorization> implements AuthorizationStore {
   ...
   */
  public AuthorizationStoreXML(File location) {
    super(location);
  }
  ...
  public XStream getParser() {
    XStream localXstream = XStreamFactory.getInstance().getXStream(MediaType.APPLICATION_XML);
