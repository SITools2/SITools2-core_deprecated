...
public final class DataSourceMonitoringResource extends AbstractDataSourceResource {
  ...
  public Representation get(Variant variant) {
    ...
    try {
      ...
      if (getDatasourceId() != null) {
        SitoolsDataSource sds = SitoolsDataSourceFactory.getDataSource(getDatasourceId());
        traceStatus(sds, messages);
      }
      else {
        ArrayList<SitoolsDataSource> dataSources = SitoolsDataSourceFactory.getAll();
        for (SitoolsDataSource sitoolsDataSource : dataSources) {
   ...
   */
  private void traceStatus(SitoolsDataSource sitoolsDataSource, ArrayList<String> messages) {
