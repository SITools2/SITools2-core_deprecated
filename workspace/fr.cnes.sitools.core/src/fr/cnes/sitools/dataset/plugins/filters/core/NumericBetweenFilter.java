          ...
          if (parameters.length >= VALUES) {
            ...
            if (columnAlias != null) {
              ...
              if (col != null && col.getFilter() != null && col.getFilter() && checkValues(parameters, col)) {
                ...
                predicat.setRightValue(new BigDecimal(numericBetween.getFrom().toString()).toPlainString());
                ...
                predicat.setRightValue(new BigDecimal(numericBetween.getTo().toString()).toPlainString());
                predicats.add(predicat);
              }
            }
