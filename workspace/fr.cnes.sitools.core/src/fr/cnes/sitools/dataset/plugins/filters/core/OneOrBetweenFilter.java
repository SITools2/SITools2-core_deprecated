            ...
            if (columnAlias != null) {
              ...
              if (col != null && col.getFilter() != null && col.getFilter() && checkValues(parameters, col)) {
                if (values instanceof NumericBetweenSelection) {
                  ...
                  predicat.setRightValue(new BigDecimal(val.getFrom().toString()).toPlainString());
                  ...
                  predicat.setRightValue(new BigDecimal(val.getTo().toString()).toPlainString());
                  predicats.add(predicat);
                }
                else {
                  Predicat predicat = new Predicat();
                  ...
                  predicat.setRightValue(new BigDecimal(values.toString()).toPlainString());
                  predicats.add(predicat);
                }
              }
            }
