...
public class DatabaseRequestParameters {
  ...
  public DatabaseRequestParameters(SitoolsDataSource db, int startIndex, Boolean distinct, boolean isCountDone,
      DataSet dataset, List<Predicat> predicats, List<Structure> structures, String orderBy,
  ...
  /**
   * Gets the list of all the visible columns in the request set to visible or asked (SQL + Virtual)
   * NoClientAccess column are not added
   * 
