...
public final class OpenSearchActionResource extends AbstractSearchResource {
  ...
  private Response createSolRIndex(final DataSet ds, final Opensearch os) {
    ...
    DataConfigDTO dataConf = createSolRdbConfig(ds, columns);
   ...
   */
  private DataConfigDTO createSolRdbConfig(DataSet ds, final List<Column> columns) {
    ...
    DataConfigDTO dataConf = new DataConfigDTO();
