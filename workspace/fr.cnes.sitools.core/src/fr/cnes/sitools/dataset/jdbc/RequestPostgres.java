 ...
 * 
 * @author AKKA
 * <a href="https://sourceforge.net/tracker/?func=detail&aid=3419661&group_id=531341&atid=2158259">[3419661]</a><br/>
...
public final class RequestPostgres implements RequestSql {
  ...
  public String getFilter(Predicat predicat) {
    ...
    pred += predicat.getCompareOperator();
    // jointure ou filtre

    if (predicat.getRightValue() != null) {
      // filtre
      if (predicat.getRightValue() instanceof String) {
        pred += ((String) predicat.getRightValue()).replace("\"", "\'");
      }
  ...
  public String getOrderBy(DataSet ds) {
    String orderBy = "";
    List<Column> columnsOrderBy = ds.getColumnOrdreBy();
