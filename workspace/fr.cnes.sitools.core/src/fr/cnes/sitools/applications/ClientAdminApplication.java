...
public final class ClientAdminApplication extends StaticWebApplication {
  ...
  public Restlet createInboundRoot() {
    ...
    DirectoryProxy dpTemplate = new DirectoryProxy(getContext(), "file:///" + templateDir,
        getAttachementRef());
    
    DirectoryProxy dpCss = new DirectoryProxy(getContext(), "file:///" + cssDir,
        getAttachementRef());
    
    DirectoryProxy dpLicence = new DirectoryProxy(getContext(), "file:///" + licenceDir,
        getAttachementRef());
   ...
   * @param cssDir the cssDir to set
   */
   ...
   * @param licenceDir the licenceDir to set
   */
