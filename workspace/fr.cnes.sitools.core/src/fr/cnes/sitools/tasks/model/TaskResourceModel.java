...
public class TaskResourceModel extends ResourceModel {
  ...
  public TaskResourceModel() {
    ...
    ResourceParameter image = new ResourceParameter(IMAGE_PARAM_NAME, "The image url",
  ...
  public String getImage() {
    ResourceParameter image = this.getParameterByName(IMAGE_PARAM_NAME);
    if (image != null) {
  ...
  public void setImage(String image) {
    ResourceParameter imageParam = this.getParameterByName(IMAGE_PARAM_NAME);
    if (imageParam != null) {
