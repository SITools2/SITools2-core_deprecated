...
public final class DirectoryUser extends DirectoryProxy {
  ...
  /**
   * To manage the POST JSON representation (command/preferences/...) 
   * as a file into the user directory (creates the directories path if needed).
   * 
   * @param request
   *          Request
   * @param response
  ...
  public void handle(Request request, Response response) {
    ...
    if ((storage != null) && storage.getStatus().equals(UserStorageStatus.ACTIVE) && request.getMethod().equals(Method.POST)
      ...
      if ((storage != null) && storage.getStatus().equals(UserStorageStatus.ACTIVE)) {
        ...
        // TODO Representations XML, HTML, Redirection page status erreur
   ...
   * overrides DirectoryProxy getJsonRepresentation for producing a specific
   * representation of a user directory 
   * 
   * @param reference
   *          the reference used
