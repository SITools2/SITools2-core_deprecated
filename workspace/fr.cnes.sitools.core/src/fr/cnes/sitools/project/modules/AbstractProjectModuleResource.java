...
public abstract class AbstractProjectModuleResource extends SitoolsResource {
  ...
  /** store */
  private SitoolsStore<ProjectModule> store = null;
   ...
   */
  public final ProjectModule getObject(Representation representation, Variant variant) {
    ProjectModule projectModuleInput = null;
    if (MediaType.APPLICATION_XML.isCompatible(representation.getMediaType())) {
      // Parse the XML representation to get the ProjectModule bean
      XstreamRepresentation<ProjectModule> repXML = new XstreamRepresentation<ProjectModule>(representation);
      ...
      projectModuleInput = new JacksonRepresentation<ProjectModule>(representation, ProjectModule.class).getObject();
    }
   ...
   */
  public final void setStore(SitoolsStore<ProjectModule> store) {
    this.store = store;
  }
   ...
   * @return the store
   */
  public final SitoolsStore<ProjectModule> getStore() {
    return store;
  }
