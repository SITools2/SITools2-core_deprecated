...
public final class UserStorageResource extends AbstractUserStorageResource {
  ...
  protected Representation get(Variant variant) {
    ...
    if (storage != null) {
      ...
      UserStorageManager.refresh(storage);
      getStore().update(storage);

      Response response = new Response(true, storage, UserStorage.class);
  ...
  public Representation doDelete(Representation representation, Variant variant) {
    // UserStorageManagement application = (UserStorageManagement) getApplication();
  ...
  public Representation doPut(Representation representation, Variant variant) {
    ...
    if (getIdentifier() != null) {
      ...
      if (storage != null) {
        ...
        response = new Response(true, storageOut, UserStorage.class);
      }
      else {
  ...
  protected Representation doIt(Representation representation) {
    ...
    try {
      ...
      File cible = new File(storage.getStorage().getUserStoragePath() + filepath, filename);
