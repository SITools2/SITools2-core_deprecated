...
-1.1 (2013-02-11)
	* Bugs fixed : 
		...
		- Bad datastorage url check when creating a new datastorage
	...
	* Enhancements : 
		...
		- patch BUG 3568982 (dictionary not saved in dataset preferences)
		- external url are not opened from the dataview
