 ...
 * @class sitools.admin.datasource.DataBasePropPanel
 * @extends Ext.Window
 */
sitools.admin.datasource.DataBasePropPanel = Ext.extend(Ext.Window, {
//sitools.component.datasource.DataBasePropPanel = Ext.extend(Ext.Window, {
    width : 700,
    height : 480,
    modal : true,
    ...
    initComponent : function () {
        ...
        sitools.admin.datasource.DataBasePropPanel.superclass.initComponent.call(this);
    },
    onRender : function () {
        sitools.admin.datasource.DataBasePropPanel.superclass.onRender.apply(this, arguments);
...
Ext.reg('s-databaseprop', sitools.admin.datasource.DataBasePropPanel);
