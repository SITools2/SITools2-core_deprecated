 ...
 * @requires sitools.admin.datasource.DataBasePropPanel
 * @requires sitools.admin.datasource.DataBaseTest
 * @class sitools.admin.datasource.DataBaseCrudPanel
 * @extends Ext.grid.GridPanel
 */
sitools.admin.datasource.DataBaseCrudPanel = Ext.extend(Ext.grid.GridPanel, {
//sitools.component.datasource.DataBaseCrudPanel = Ext.extend(Ext.grid.GridPanel, {
    ...
    initComponent : function () {
        ...
        sitools.admin.datasource.DataBaseCrudPanel.superclass.initComponent.call(this);
    },

    onRender : function () {
        sitools.admin.datasource.DataBaseCrudPanel.superclass.onRender.apply(this, arguments);
        this.store.load({
            params : {
                start : 0,
                limit : this.pageSize
    ...
    _onCreate : function () {
        var dbp = new sitools.admin.datasource.DataBasePropPanel({
            url : this.url,
            action : 'create',
            store : this.store
        });
    ...
    _onView : function () {
        ...
        var up = new sitools.admin.datasource.DataBasePropPanel({
            url : this.url + '/' + rec.id,
            action : 'view',
            store : this.store
        });
...
Ext.reg('s-database', sitools.admin.datasource.DataBaseCrudPanel);
