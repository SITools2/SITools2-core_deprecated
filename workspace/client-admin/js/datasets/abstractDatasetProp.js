            ...
            Ext.Ajax.request({
                ...
                success : function (ret) {
                    ...
                    this.formulairePrincipal.getDataSourceCombo().getStore().load({
                        ...
                        callback : function () {
                            if (data.datasource) {
                                this.findByType('form')[0].getComponent('comboDataSource').setValue(data.datasource.id);
                            }
                        }
                    });
...
//                        this.loadColumnsJDBC();
                        ...
                        var storeWhereClause = this.wizardWhereClause.getStore();
                    ...
                    if (! Ext.isEmpty(data.structure)) {
						this.wizardJoinCondition.items.items[0].loadTree(data);
                    }
