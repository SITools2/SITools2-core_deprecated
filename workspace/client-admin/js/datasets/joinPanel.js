 ...
 * @cfg {Ext.grid.GridPanel} gridTablesDataset (required) The grid that shows dataset tables
...
sitools.component.datasets.joinCrudTreePanel = Ext.extend(Ext.tree.TreePanel, {
    ...
    buildDefault : function () {
        ...
        if (this.gridTablesDataset.getStore().getCount() !== 0 && Ext.isEmpty(this.getRootNode().attributes.table)) {
			var rec = this.gridTablesDataset.getStore().getAt(0);
			...
			var i = 0;
			this.gridTablesDataset.getStore().each(function (rec) {
				if (i !== 0) {
