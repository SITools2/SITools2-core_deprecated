    ...
    initComponent : function () {
        ...
        this.cm = new Ext.grid.ColumnModel({
            ...
            columns : [ {
                ...
                header : i18n.get('label.freeUserSpace') + " (" + i18n.get("label.quota.unit") + ")",
                dataIndex : 'freeUserSpace',
                width : 100
            }, {
                header : i18n.get('label.busyUserSpace') + " (" + i18n.get("label.quota.unit") + ")",
                dataIndex : 'busyUserSpace',
                width : 100
            }, {
                header : i18n.get('label.quota') + " (" + i18n.get("label.quota.unit") + ")",
                dataIndex : 'quota',
                width : 100
            }, {
