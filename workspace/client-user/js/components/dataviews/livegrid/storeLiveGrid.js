...
//sitools.user.component.livegrid.storeLiveGrid = function (config) {
	 ...
	 */
    var map = this.getFields(config.datasetCm);
    var primaryKey = this.getPrimaryKey(config.datasetCm);
    /*
    ...
    Ext.apply(config, {
        ...
        listeners : {
            ...
            exception : function (dp, type, action, options, response, arg) {
                ...
                this.mainView.ownerCt.minimize();
                var win = this.mainView.ownerCt;
