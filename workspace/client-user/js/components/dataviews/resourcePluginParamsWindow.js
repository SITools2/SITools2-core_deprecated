 ...
 * @class sitools.user.component.dataviews.resourcePluginParamsWindow
 * @extends Ext.Window
 */
sitools.user.component.dataviews.resourcePluginParamsWindow = Ext.extend(Ext.Window, {
//sitools.user.component.livegrid.resourcePluginParamsWindow = Ext.extend(Ext.Window, {
    ...
    initComponent : function () {
        this.title = i18n.get("label.resourceReqParam"); 
	...
	//            title : "Request parameters",
        ...
        sitools.user.component.dataviews.resourcePluginParamsWindow.superclass.initComponent.call(this);
