 ...
 * @class sitools.user.component.dataviews.goToTaskWindow
 * @extends Ext.Window
 */
sitools.user.component.dataviews.goToTaskWindow = Ext.extend(Ext.Window, {
//sitools.user.component.livegrid.goToTaskWindow = Ext.extend(Ext.Window, {
//    modal : true,
    width : "500", 
    buttonAlign : 'left',
    initComponent : function () {
        ...
        sitools.user.component.dataviews.goToTaskWindow.superclass.initComponent.call(this);
