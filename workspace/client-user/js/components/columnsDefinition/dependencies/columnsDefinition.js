...
sitools.user.component.columnsDefinition = function (config) {
    ...
    this.datasetCm = config.datasetCm;
	...
	this.grid = new Ext.grid.GridPanel({
        ...
        tbar : {
            ...
            items : [ {
                text : i18n.get('label.toggleGroup'),
                icon : loadUrl.get('APP_URL') + '/common/res/images/icons/toggle_group.png',
...
Ext.extend(sitools.user.component.columnsDefinition, Ext.Panel, {
    ...
    _getSettings : function () {
        var colModel = [];
        return (extColModelToJsonColModel(this.grid.getColumnModel().config));
    },
