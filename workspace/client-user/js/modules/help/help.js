...
/**
 * Help Module
 * @class sitools.user.modules.help
 * @extends Ext.Panel
 */
sitools.user.modules.help = Ext.extend(Ext.Panel, {
    /**
    ...
    initComponent : function () {
        ...
        sitools.user.modules.help.superclass.initComponent.call(this);
    },

    onRender : function () {
        sitools.user.modules.help.superclass.onRender.apply(this, arguments);
...
Ext.reg('sitools.user.modules.help', sitools.user.modules.help);
