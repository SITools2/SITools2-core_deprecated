...
sitools.user.modules.userSpaceDependencies.orderProp = Ext.extend(Ext.Panel, {
    pageSize : 10,
    dataSets : "",
    autoScroll : true, 
	layout : 'fit', 
    ...
    initComponent : function () {
        ...
        sitools.user.modules.userSpaceDependencies.orderProp.superclass.initComponent.call(this);
    },

    onRender : function () {
        sitools.user.modules.userSpaceDependencies.orderProp.superclass.onRender.apply(this, arguments);
            ...
            success : function (response, opts) {
                try {
                    ...
                    var windowConfig = {
                        ...
                        saveToolbar : true, 
                        urlPreferences : loadUrl.get('APP_URL') +  AppUserStorage + "/" + DEFAULT_PREFERENCES_FOLDER + "/" + projectGlobal.projectName + "/" + json.dataset.name + "/data", 
                        type : "data"
                    };
                    SitoolsDesk.addDesktopWindow(windowConfig, componentCfg, jsObj);
...
Ext.reg('s-orderprop', sitools.user.modules.userSpaceDependencies.orderProp);
