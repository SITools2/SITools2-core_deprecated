 ...
 * config { url + handler }
 */
sitools.widget.Register = Ext.extend(Ext.Window, {
    id: 'winRegister',
	layout: 'hbox',
	width: 420,
	height: 490,
	...
	initComponent: function () {
	    ...
	    this.items = [{
			...
			buttonAlign: 'center',
			id: 'frmRegister',
			bodyStyle: 'padding:10px 10px 0px 60px; background:url("'+loadUrl.get('APP_URL')+'/common/res/images/ux/register-big.gif") no-repeat #dfe8f6;',
			width: 400,
			height : 420,
			labelWidth: 120,
			items: [{
			...
			buttons: [
				...
				{ text: i18n.get('label.reset'), reloadUrl : this.captchaUrl, handler: function () {
					...
					handler: function () {
		        		...
		        		var login = new sitools.widget.Login({
        ...
        sitools.widget.Register.superclass.initComponent.call(this);
	},
...
Ext.reg('s-register', sitools.widget.Register);
