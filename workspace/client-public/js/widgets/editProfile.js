 ...
 * config { url + handler }
 */
sitools.widget.editProfile = Ext.extend(Ext.Window, {
    id : 'winEditProfile',
    layout : 'hbox',
    width : 420,
    height : 410,
    ...
    initComponent : function () {
        ...
        sitools.widget.editProfile.superclass.initComponent.call(this);
    ...
    saveEdit : function () {
        ...
        Ext.getCmp('winEditProfile').body.mask();
        ...
        Ext.Ajax.request({
            ...
            success : function (response, opts) {
                ...
                if (json.success) {
                    Ext.getCmp('winEditProfile').close();
    ...
    onRender : function () {
        sitools.widget.editProfile.superclass.onRender.apply(this, arguments);
        if (this.url) {
            Ext.Ajax.request({
                url : this.url,
                method : 'GET',
