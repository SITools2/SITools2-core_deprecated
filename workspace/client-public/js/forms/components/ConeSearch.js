...
sitools.common.forms.components.AbstractConeSearch = Ext.extend(sitools.common.forms.AbstractWithUnit, {
    ...
    resolveTargetName : function () {
    	...
    	var url = baseUrl + "/" + this.targetName.getValue() + "/" + this.extraParams.coordSystem + "?nameResolver=" + this.extraParams.resolverName;
    	this.getEl().mask();
    	Ext.Ajax.request({
    		url : url, 
    		scope : this, 
    		...
    		success : function (ret) {
    			try {
    				...
    				this.raParam.setValue(json.ra);
    				this.decParam.setValue(json.dec);
    			}
    			catch(err) {
